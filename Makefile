...
dm_proto:
	(cd devicemanager; protoc -I protos --go_out=plugins=grpc:protos protos/device_manager.proto)
dm_server:
...
inv_proto:
	(cd inventory; protoc -I protos --go_out=plugins=grpc:protos protos/inventory.proto)
inv_server:
