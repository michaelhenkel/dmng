...
dm_proto:
	(cd devicemanager; protoc -I protos --go_out=:${GOPATH}/src protos/device_manager.proto)
dm_server:
...
inv_proto:
	(cd inventory; protoc -I protos -I ../devicemanager/protos/devicemanager --go_out=:${GOPATH}/src protos/inventory.proto)
inv_server:
